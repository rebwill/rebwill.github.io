              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    A simple React app that displays the current weather in the
                    requested location. Built with React, WeatherAPI.com&apos;s
                    RESTful API, and React Router. Deployed on Heroku.
                  </p>
                  <a
            ...
            <div className="col-lg-4 d-flex">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    A collection of recipes for our monthly gathering of friends
                    to cook a decadent vegan brunch together. Built with
                    Node.js, HTML, and CSS. Deployed on Heroku.
                  </p>
                  <a
            ...
            <div className="col-lg-4 d-flex">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    A simple re-creation of Meetup.com, displaying meetup groups
                    and associated events using HTML, CSS, Javascript, React,
                    React Router and React Context API. Deployed on Netlify.
                  </p>
                  <a
            ...
            <div className="col-lg-4 d-flex">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Add, delete, or complete tasks on your to-do list.
                    Unfortunately does not include any fixes for
                    procrastination. Built with HTML, CSS, Javascript, and
            ...
            <div className="col-lg-4 d-flex">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Allows ocean lovers to discover and donate to organizations
                    working in coral restoration all over the world. Built with
                    HTML, CSS, Javascript, React, React Router, React Context
        ...
        <div className="container-fluid about-container" id="about">
          <div className="row about-row-1">
            <div className="col-md-4 d-flex">
              <img
                className="img-fluid rounded-circle rebeccaheadshot"
                src={rebeccaHeadshot}
              />
            </div>
            <div className="col-md-8 about-text right-column right-column-mobile">
              <h1>About Me</h1>
              <p>
                My professional career has covered a lot of ground throughout
                the worlds of tech, startups, and social entrepreneurship in the
                US and Latin America. After leading BUILDING.co, Miami&apos;s
                premier coworking space for tech companies, for two years as the
                General Manager, I decided I was ready for yet another new
                challenge — so I began my coding journey in 2019 with 4Geeks
                Academy&apos;s full stack web development bootcamp.
                <br />
                <br />
                I&apos;m now seeking a web developer role in the Miami area.
                I&apos;m proficient in HTML, CSS, Javascript, and React, and
                have basic knowledge of Node.js and RESTful APIs. I am excited
                to deepen my expertise in these technologies and continue adding
                new tools to my belt.
                <br />
                <br />I hold a BA in International Affairs and Anthropology from
                Northeastern University in Boston and an MBA from the
                Universidad de Palermo in Buenos Aires, Argentina.
                <br />
                <br />
                I&apos;m an active member of the Miami startup and tech
                community. I&apos;m an organizer of our local{" "}
                <a
                  href="https://www.1millioncups.com/miami"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  1 Million Cups
                ...
                <a href="https://theideacenter.co">the Idea Center</a> of Miami
                Dade College on rapid prototyping for business model validation;
                and I&apos;m a member of the Global Shapers{" "}
                <a
                ...
                I&apos;m passionate about promoting diversity and inclusion in
                our community, as well as environmental causes. I&apos;m also an
                avid scuba diver and love exploring South Florida&apos;s marine
                ecosystems, including volunteering as a diver with the Coral
          ...
          <div className="row about-row-1">
            ...
            <div className="col-md-8 about-text right-column">
              ...
              <p className="contact-p">
                ...
                <strong>willett.rebecca at gmail.com</strong>.<br />
                <br />
                ...
                ,{" "}
                <a
                  href="https://twitter.com/rebeccaAwillett"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Twitter
